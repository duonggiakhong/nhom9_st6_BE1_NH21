...
<div class="content-wrapper">
  ...
  <section class="content">
    <form action="add manufacture.php" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col-12 ">
    ...
    <div class="row">
      <div class="col-12">
        <input name='submit' type="submit" value="Create new manufacture" class="btn btn-success ">
